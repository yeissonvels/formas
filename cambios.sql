...
ALTER TABLE `ge_incidences` CHANGE `code` `code` VARCHAR(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT '';
ALTER TABLE `ge_incidences` CHANGE `store` `store` INT(11) NULL DEFAULT NULL COMMENT 'Sólo cuando la incidencia no pertenece a un pedido';
ALTER TABLE `ge_incidences` CHANGE `deliveryzone` `deliveryzone` INT(11) NULL DEFAULT NULL COMMENT 'Sólo cuando la incidencia no pertenece a un pedido';
