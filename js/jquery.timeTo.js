...
(function (factory) {
    ...
    var dictionary = {
        ...
        sp:{days:"dÃ­as", hours:"reloj", min:"minutos", sec:"segundos"},
    ...
    $.fn.timeTo = function(){
        var defaults = {
                ...
                captionSize: 11,          // font-size by pixels for captions, if 0 then calculate automaticaly
                ...
                fontSize: 20,            // font-size of a digit by pixels
