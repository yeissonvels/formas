...
<?php
    ...
    if (!$data) {
        $canEdit = true;
        $disabled = '';
    } else if ($data && $data->orderexist == 0 && !isTimeOver($data->created_on) || $user->getUsermanager() == 1) {
        $canEdit = true;
        $disabled = '';
    }
    ...
    <div class="card-block">
        <form id="frm-saledata">
            <div class="form-group row">
                <label for="saletype"
                       class="col-sm-1 col-form-label">Tipo</label>
                <div class="col-sm-5">
            ...
            <div class="form-group row" id="div_parentcode" style="<?php echo $displayParentCode?>">
                <label for="parentcode"
                       class="col-sm-1 col-form-label">Nº de pedido asociado</label>
                <div class="col-sm-5">
                    <input type="text" id="search-box" placeholder="Código o nombre del cliente"  class="form-control" value="<?php echo $parentValue; ?>"/>
            ...
            <div class="form-group row" id="div_saledate">
                <label for="saledate"
                       class="col-sm-1 col-form-label">Fecha de venta/ variación</label>
                <div class="col-sm-5">
            ...
            <div class="form-group row" id="div_code" style="<?php echo $displayCode; ?>">
                <label for="code"
                       class="col-sm-1 col-form-label">Nº de pedido</label>
                <div class="col-sm-5">
            ...
            <div class="form-group row" id="div_customer" style="<?php echo $displayCustomer; ?>">
                <label for="customer"
                       class="col-sm-1 col-form-label">Titular del pedido</label>
                <div class="col-sm-5">
            ...
            <div class="form-group row" id="div_total">
                ...
                ?>
                <label for="total"
                       class="col-sm-1 col-form-label"><span id="totallabel"><?php echo $totalLabel; ?></span></label>
                <div class="col-sm-5">
            ...
            <div class="form-group row" id="div_payed">
                <label for="payed"
                       class="col-sm-1 col-form-label">Abonado a cuenta</label>
                <div class="col-sm-5">
            ...
            <div class="form-group row" id="div_paymethod">
                <label for="paymethod"
                       class="col-sm-1 col-form-label">Mediante</label>
                <div class="col-sm-5">
            ...
            <div class="form-group row">
                <label for="salecomment"
                       class="col-sm-1 col-form-label">Nota de venta</label>
                <div class="col-sm-7">
                    <textarea id="salecomment" name="salecomment" class="form-control"
                              onclick="border_ok('#salecomment')" <?php echo $disabled; ?>><?php echo $data ? $data->salecomment : ''; ?></textarea>
                </div>
                <?php if ($canEdit) {
                    $btnLabel = 'venta';
                    if ($data && $data->saletype == 1) {
        ...
        <div id="div_pdf" style="<?php echo $displayPdf; ?>">
            ...
            <div class="form-group row">
                <label for="comment"
                       class="col-sm-1 col-form-label">Comentario de la propuesta de pedido</label>
                <div class="col-sm-8">
                        <textarea id="comment" name="comment" class="form-control"
                                  onclick="border_ok('#comment')" <?php echo $pdfDisabled; ?>></textarea>
                </div>
            </div>
            <div class="form-group row">
                <label for="file"
            ...
            <div id="ajax-content">
                ...
                if ($data) {
                    if ($data->pdfname != "") {
                        $url = "/uploaded-files/pdfs/" . $data->id . "/" . $data->pdfname;
                        confirmationMessage('Nota de entrega actual <a href="' . $url . '" target="_blank">' . icon('pdf', false) . '</a>');
                        $deleteLk = $data->orderexist == 0  || $user->getUsermanager() == 1 ? true : false;
                        echo '<div>';
                        echo    '<b>Otras versiones de la propuesta de pedido:</b> <br>';
                        $config = array(
                            'divresponse' => 'ajax-content',
                            'excludes' => array($data->pdfname)
                        );
