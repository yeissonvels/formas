        ...
        <div class="card-block">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="productname" id="productname"
                       placeholder=""
                       value="<?php echo($data ? $data->getProductname() : ""); ?>">
            </div>
            ...
            <div class="form-group">
                <input type="hidden" name="opt" id="opt"
                       value="<?php echo $data ? 'save_edit_product' : 'save_product' ?>">
                <input type="hidden" name="controller" value="<?php echo FORM_CONTROLLER; ?>">
                <input type="hidden" name="show" value="show_products">
                <?php
                if ($data) {
